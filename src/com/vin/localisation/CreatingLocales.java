...
//        System.out.println(locale); // en_IE
        ...
        // 1. Constructors
        System.out.println(new Locale("hi"));                   // en
        Locale locEnglishIN = new Locale("hi", "IN");           // en_GB
        System.out.println(locEnglishIN.getDisplayLanguage());  // Hindi
        System.out.println(locEnglishIN.getDisplayCountry());   // India
