...
public class MethodReferenceExample {
    public static void main(String[] args) {
        ...
        methodReferenceExample.boundMethodReferences();
        methodReferenceExample.unboundMethodReferences();
        methodReferenceExample.staticMethodReferences();
        methodReferenceExample.constructorMethodReferences();
