package com.vin.stream.primitiveStream;
...
public class PrimitiveStreams {
    ...
    public static void main(String[] args) {
        System.out.println("----stats(IntStream.empty());-------");
        stats(IntStream.empty());
        System.out.println("---stats(IntStream.of(5, 10, 15, 20));---");
        stats(IntStream.of(5, 10, 15, 20));
        System.out.println("------maxMinAverage();---------");
        maxMinAverage();
        System.out.println("----mappingPrimitiveStreams();---");
        mappingPrimitiveStreams();
        System.out.println("----mappingObjectStreams();-----");
    ...
    private static void maxMinAverage() {
        ...
        // OptionalDouble min = DoubleStream.empty().min();
        // terminal operation
        // NoSuchElementException is thrown if no value present
        System.out.println(min.orElseThrow(() -> new ArithmeticException("DoubleStream is empty")));// 10.0
    ...
    public static void mappingPrimitiveStreams() {
        ...
        // The boxed method is used to convert a stream of primitives to Integer objects,
        // which are then mapped to a custom Point class instances.
        ...
        dblStream.forEach(System.out::print); // 1.0, 2.0, 3.0
